...
---
Source: ParthJadhav/app-store-screenshots (MIT), `skills/app-store-screenshots/style-prompts/_QUALITY_BAR.md`. Vendored as a reference; our render.mjs automates the composition checks from §1.
